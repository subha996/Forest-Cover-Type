...
class Data_Getter_Pred:
    ...
    def __init__(self, file_object, logger_object):
        self.prediction_file = 'Prediction_FileFromDB/InputFile.csv' # input file for prediction
        self.file_object = file_object # file object for logger
        self.logger_object = logger_object # logger object
