...
class Model_Finder:
    ...
    def get_best_params_for_random_forest(self,train_x,train_y):
        ...
        try:
            ...
            self.param_grid = {"n_estimators": [100, 130], # trying with less paramaeters due to time constraints
    ...
    def get_best_params_for_xgboost(self,train_x,train_y):
        ...
        try:
            ...
            return self.xgb # returning the best model
    ...
    def get_best_model(self,train_x,train_y,test_x,test_y):
        ...
        try:
            ...
            if(self.random_forest_score <  self.xgboost_score):
                return 'XGBoost',self.xgboost # returning the best model
            else:
                return 'RandomForest',self.random_forest # returning the best model
