...
class File_Operation:
    ...
    def save_model(self,model,filename):
        ...
        try:
            ...
            if os.path.isdir(path): #remove previously existing models for each clusters
                shutil.rmtree(self.model_directory) # remove directory : models
                os.makedirs(path) # create directory : models
            else:
                os.makedirs(path) # create directory : models
    ...
    def find_correct_model_file(self,cluster_number):
        ...
        try:
            self.cluster_number= cluster_number #receive cluster number from outer controller
