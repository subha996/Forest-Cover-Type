...
class pred_validation:
    ...
    def prediction_validation(self):
        """
        Methode Name: prediction_validation
        Description: This method validates the prediction data from the source.
        Output: A log file generated in the Logs directory.
