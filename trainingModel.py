...
class trainModel:
    ...
    def trainingModel(self):
        """
        This is the main method which call all the methods and builds the model
        Input: None
        Output: Saved best model file along with logs for each cluster.
        ...
        try:
            ...
            for i in list_of_clusters:
                ...
                model_save_status = file_op.save_model(best_model,best_model_name+str(i))
                print(f"Model Saving Status:  {model_save_status}")
